...
function parse(input) {
    ...
    var originalLength = lines.reduce((acc, line) => acc + line.length, 0);
    var afterEscapeLength = lines.reduce((acc, line) => acc + eval(line).length, 0);
    var extendedLength = lines.reduce((acc, line) => acc + JSON.stringify(line).length, 0);

    //1350
    console.log(originalLength - afterEscapeLength);
    //2085
    console.log(extendedLength - originalLength);
}
